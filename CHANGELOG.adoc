...
* Fix vertical coordinate offset in EPS rendering ({pull-request-url}/989[#989])
* Return non-zero exit code when no QR code is found
  ({pull-request-url}/1002[#1002])

== {compare-url}/v0.13.1\...v0.13.2[0.13.2] - 2025-12-20

=== Added

* Add WinGet as an installation method ({pull-request-url}/869[#869])

=== Changed

* Bump MSRV to 1.88.0 ({pull-request-url}/883[#883])
* Allow iterations higher than 255 in `--zopfli` ({pull-request-url}/894[#894])

== {compare-url}/v0.13.0\...v0.13.1[0.13.1] - 2025-10-29

=== Added

* Add more archive formats for releases ({pull-request-url}/863[#863])

== {compare-url}/v0.12.1\...v0.13.0[0.13.0] - 2025-10-29

=== Added

* Add support for encoding rMQR code ({pull-request-url}/860[#860])
* Add EPS rendering support ({pull-request-url}/861[#861])

=== Changed

* Remove `--symbol-version` from the required options of `--variant`
  ({pull-request-url}/860[#860])
